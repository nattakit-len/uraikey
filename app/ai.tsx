...
function AI() {
  ...
  return (
    <>
      <div className="container pb-[104px]">
        {data &&
          data?.map((d) => (
            <div className="tracking-tight mt-6 flex items-start ring-1 ring-slate-700/10 p-4 shadow-sm bg-white rounded-lg">
      ...
      <div className="fixed bottom-0 container bg-white ring-1 ring-slate-700/10">
        <form onSubmit={handleSummitForm} className=" py-8 w-full ">
